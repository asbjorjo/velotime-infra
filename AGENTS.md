...
- Root Helm and Kubernetes providers authenticate with the kubeconfig generated by `cluster`; do not replace this with a bearer-token assumption.
...
- Keep the generated `cluster/kubeconfig.yml` file ignored and handle it securely; it contains a client private key.
